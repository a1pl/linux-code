...
(*.[0-9]*)
	...
	if test ! -f "/home/snsk/Downloads/linux-crap/code/ncurses/ncurses-6.4/man_alias.sed" ; then
cat >>/home/snsk/Downloads/linux-crap/code/ncurses/ncurses-6.4/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/snsk/Downloads/linux-crap/code/ncurses/ncurses-6.4/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/snsk/Downloads/linux-crap/code/ncurses/ncurses-6.4/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/snsk/Downloads/linux-crap/code/ncurses/ncurses-6.4/man_alias.sed" \
		< "$i" >$TMP
